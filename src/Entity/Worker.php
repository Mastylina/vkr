...
class Worker implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Service::class, mappedBy: 'workers')]
    private $services;

    #[ORM\ManyToOne(targetEntity: PostWorker::class, inversedBy: 'workers')]
    ...
    public function getPostWorker(): ?PostWorker
    {
        return $this->postWorker;
    }

    public function setPostWorker(?PostWorker $postWorker): self
    {
